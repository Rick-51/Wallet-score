    ...
    <main className="client-site">
      <header className="client-header">
        ...
        <nav className={mobileMenu ? 'client-nav client-nav-open' : 'client-nav'} aria-label="Main navigation">
          ...
          <a href="/my-wallet">My Wallet Score</a>
      ...
      <section className="how-section" id="how-it-works">
        ...
        <div className="process-grid">
          <article><span className="process-number">01</span><div className="process-icon"><Wallet /></div><h3>Connect your wallet</h3><p>Open My Wallet Score and connect MetaMask. Your address is read directly from the connected account.</p></article>
